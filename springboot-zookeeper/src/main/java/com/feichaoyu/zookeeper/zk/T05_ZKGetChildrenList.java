 ...
 * @author feichaoyu
 */
public class T05_ZKGetChildrenList implements Watcher {
    private ZooKeeper zookeeper = null;

    public static final String zkServerPath = "192.168.1.110:2181";
    public static final Integer timeout = 5000;

    public T05_ZKGetChildrenList() {
    }

    public T05_ZKGetChildrenList(String connectString) {
        try {
            zookeeper = new ZooKeeper(connectString, timeout, new T05_ZKGetChildrenList());
        } catch (IOException e) {
            e.printStackTrace();
            if (zookeeper != null) {
                try {
    ...
    public static void main(String[] args) throws Exception {
        ...
        T05_ZKGetChildrenList zkServer = new T05_ZKGetChildrenList(zkServerPath);
