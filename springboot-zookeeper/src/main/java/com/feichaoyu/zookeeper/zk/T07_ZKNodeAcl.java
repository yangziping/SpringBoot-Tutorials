 ...
 * @author feichaoyu
 */
public class T07_ZKNodeAcl implements Watcher {
    ...
    public T07_ZKNodeAcl() {
    }

    public T07_ZKNodeAcl(String connectString) {
        try {
            zookeeper = new ZooKeeper(connectString, timeout, new T07_ZKNodeAcl());
        } catch (IOException e) {
            e.printStackTrace();
            if (zookeeper != null) {
                try {
    ...
    public static void main(String[] args) throws Exception {
        ...
        T07_ZKNodeAcl zkServer = new T07_ZKNodeAcl(zkServerPath);
