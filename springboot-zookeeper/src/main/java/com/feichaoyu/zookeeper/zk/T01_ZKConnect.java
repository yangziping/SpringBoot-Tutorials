 ...
 * @author feichaoyu
 */
public class T01_ZKConnect implements Watcher {

    private static final Logger log = LoggerFactory.getLogger(T01_ZKConnect.class);
    ...
    public static void main(String[] args) throws Exception {
         ...
         */
        ZooKeeper zk = new ZooKeeper(zkServerPath, timeout, new T01_ZKConnect());
