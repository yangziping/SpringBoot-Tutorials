 ...
 * @author feichaoyu
 */
public class T04_ZKGetNodeData implements Watcher {
    ...
    public T04_ZKGetNodeData() {
    }

    public T04_ZKGetNodeData(String connectString) {
        try {
            zookeeper = new ZooKeeper(connectString, timeout, new T04_ZKGetNodeData());
        } catch (IOException e) {
            e.printStackTrace();
            if (zookeeper != null) {
                try {
    ...
    public static void main(String[] args) throws Exception {
        ...
        T04_ZKGetNodeData zkServer = new T04_ZKGetNodeData(zkServerPath);
